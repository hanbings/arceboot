...
echo "[2/3] 准备 EDK2 构建环境..."
cd "$WORKSPACE_DIR"

if [ ! -d "ToolChain/RISCV" ]; then
    echo "下载 RISCV 工具链..."
    mkdir -p ToolChain/RISCV
    wget https://github.com/riscv-collab/riscv-gnu-toolchain/releases/download/2025.07.16/riscv64-elf-ubuntu-24.04-gcc-nightly-2025.07.16-nightly.tar.xz
